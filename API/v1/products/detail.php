...
// DEBUG: Log progress for product 83983
if ($product_id == 83983) {
    error_log("Product 83983: Found product, starting colors query");
}
...
$response = array(
    ...
    'data' => array(
        ...
        'name' => utf8_encode($product['item_title']),
        'price' => floatval($product['Price']),
        ...
        'sku' => $product['FormID'],
        'description' => $product['Description'] ? utf8_encode($product['Description']) : 'Quality DentWizard apparel',
