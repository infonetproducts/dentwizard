...
if($action=='save'){
	...
	if(!$id){
		...
		mysql_query("insert Items set CID='$CID',FormID='$iid',Description='$templatename',MinQTY=250,MaxQTY=500,UserID='$uid' , item_type='on_demand' ,  item_title='$templatename'  ");
		$id=mysql_insert_id();
		if($id){
	...
	mysql_query("update BusinessCardData set Name='$vals[Name]', CompanyName='$vals[CompanyName]', Title='$vals[Title]', Title2='$vals[Title2]',
		...
		WebsiteURL='$vals[WebsiteURL]', Facebook='$vals[Facebook]', Twitter='$vals[Twitter]', NumYears='$vals[NumYears]' ,Photo='$vals[Photo]',CubicleNumber='$vals[CubicleNumber]' ,warehouse_id='$vals[warehouse_id]'  ,RetailerName='$vals[RetailerName]' , DealerName='$vals[DealerName]'
		where ItemID='$id'");
	if(!$isnew){
...
//	sleep(1);
	...
	header("Location: index.php?catid=4#all");
...
<section class="titlebar">
	<div class="container">
		<div class="sixteen columns">
			<h2>Create/Edit Business Card</h2>
			
			<nav id="breadcrumbs">
				<ul>
					<li><a href="#">Home</a></li>
					<li>Create/Edit Business Card</li>
				</ul>
			</nav>
		</div>
	</div>
 ...
 <div class="six columns centered">
		...
		<div class="tabs-container">
			...
			<div class="tab-content" id="tab1" style="display: block;">
				...
				<form method="post" action="bceditindex.php">
				...
				// pr($present);
                    ...
                    ?>
                      <p class="form-row form-row-wide">
                        ...
                        <input class="input-text" type="text" size="30" name="Name" value="<?php echo $item[Name];?>" />
  ...
  <?php
					...
					?>
                      ...
                      <p class="form-row form-row-wide">
                       ...
                       <textarea name="Photo" cols="90" rows="2"><?php echo $item["Photo"];?></textarea>
...
?>	
				...
				?>  
                   ...
                   <p class="form-row form-row-wide"> 
                  <input type="submit" value="SAVE" style="di" /> 
