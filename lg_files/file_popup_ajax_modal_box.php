...
<div align="center"  style="background-color:#FFFFFF" >
  <table class="cart-table responsive-table" width="650" border="2" align="center" cellpadding="6" cellspacing="0" bordercolor="#e0e0e0">
    <tr>
      <td bgcolor="#FFFFFF"><table class="cart-table responsive-table"" width="100%" border="0" align="center" cellpadding="2" cellspacing="4">
          <tr>
            <td><div align="left"><font size="2" face="Arial, Helvetica, sans-serif"><strong>Item #:</strong> <?php echo $formid;?></font></div></td>
          </tr>
          
           <tr>
            <td><div align="left"><font size="2" face="Arial, Helvetica, sans-serif"><strong>Price :</strong> $<?php echo number_format($price,2);?></font></div></td>
          </tr>
          ...
          <tr>
			...
			if($row_item['is_custom_order_item']!="Y")
			{
            ?>
