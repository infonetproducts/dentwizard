...
//pr_n($item_list);
		...
		<div class="four columns p-list">
			<figure class="product">
					<div class="mediaholder">
				<!--href="variable-product-page.html"-->
					<a onclick="custom_item('<?php echo $item_detail[ID];?>');" href="#">
					...
					<a onclick="custom_item('<?php echo $item_detail[ID];?>');"  class="product-button"><i class="fa fa-shopping-cart"></i> VIEW DETAILS </a>
			...
			-->
				...
				?>
				 ...
				 <a href="#" onclick="custom_item('<?php echo $item_detail[ID];?>');">
					<section>
