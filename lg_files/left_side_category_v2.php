  ...
  $numcats = mysql_num_rows($mainrs); 
			...
			if($numcats>0)
			{
				...
				while($parent_category_detail = mysql_fetch_assoc($mainrs) )
				{
						...
						if(empty($item_list_tmp_for_cat) and $cat_id_tmp!=1935)
						{
							continue ; 
						}
						...
						if($cat_id_tmp==1935  and !isset($_GET['catid']))
						{
							header("location:index.php?catid=1935");
							die;	
						}else{
							
							if($is_first_cat==1 and !isset($_GET['catid']))
							{
